...
<div id="info">
    <div id="info_top">
        <ul>
            ...
            <li class="remove_rightBorder large_content_li canOrder" onclick="reOrder('collectionInformationNumber',this)">样本编号<span></span></li>
            <li class="remove_rightBorder large_content_li canOrder" onclick="reOrder('collectionInformationName',this)">样本名称<span></span></li>
            <li class="remove_rightBorder large_content_li canOrder" onclick="reOrder('collectionInformationDescription',this)">样本描述<span></span></li>
...
<div id="AMLayer" class="addAndModifyLayer">
    <div>样本编号:<input type="text" id="collection_number_AMLayer" autofocus><span id="detectNum_AMLayer"></span></div>
    <div>样本名称:<input type="text" id="collection_name_AMLayer"></div>
    <div>样本描述:<input type="text" id="collection_description_AMLayer"></div>
...
<script src="../lib/require.js" data-main="collectionInformation"></script>
</body>
</html>
