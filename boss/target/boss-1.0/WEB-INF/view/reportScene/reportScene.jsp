...
<div id="info">
    <div id="info_top">
        <ul>
            ...
            <li class="remove_rightBorder large_content_li canOrder" onclick="reOrder('reportSceneNumber',this)">编号<span></span></li>
            <li class="remove_rightBorder large_content_li canOrder" onclick="reOrder('reportSceneName',this)">报告场景名称<span></span></li>
            <li class="remove_rightBorder large_content_li canOrder" onclick="reOrder('reportSceneDescription',this)">报告场景描述<span></span></li>
...
<div id="AMLayer" class="addAndModifyLayer_medium">
    <div>报告场景编号:<input type="text" id="reportScene_number_AMLayer" autofocus><span id="detectNum_AMLayer"></span>
    </div>
    <div>报告场景名称:<input type="text" id="reportScene_name_AMLayer"></div>
    <div>报告场景描述:<input type="text" id="reportScene_description_AMLayer"></div>
...
<script src="../lib/require.js" data-main="reportScene"></script>
</body>
</html>