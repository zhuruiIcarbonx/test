...
<div id="info">
    <div id="info_top">
        <ul>
            ...
            <li class="remove_rightBorder large_content_li canOrder" onclick="reOrder('sequenceScopeNumber',this)">编号<span></span></li>
            <li class="remove_rightBorder large_content_li canOrder" onclick="reOrder('sequenceScopeName',this)">测序名称<span></span></li>
            <li class="remove_rightBorder large_content_li canOrder" onclick="reOrder('sequenceScopeDescription',this)">测序范围描述<span></span></li>
...
<div id="AMLayer" class="addAndModifyLayer_medium">
    <div>测序范围编号:<input type="text" id="sequenceScope_number_AMLayer" autofocus><span id="detectNum_AMLayer"></span></div>
    <div>测序范围名称:<input type="text" id="sequenceScope_name_AMLayer"></div>
    <div>测序范围描述:<input type="text" id="sequenceScope_description_AMLayer"></div>
...
<script src="../lib/require.js" data-main="sequenceScope"></script>
</body>
</html>